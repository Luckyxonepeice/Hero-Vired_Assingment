...
const ProgramList = ({input}) => {
  const data = [
    { id: 1, name: 'Program 1', imageUrl: 'url1', createdDate: '2022-01-01' },
    { id: 2, name: 'Program 2', imageUrl: 'url2', createdDate: '2022-02-15' },
    { id: 3, name: 'Program 3', imageUrl: 'url3', createdDate: '2022-03-22' },
        ...
        {filteredData.map((program) => (
          <div key={program.id} style={styles.programCard}>
            ...
            <div style={styles.programDetails}>
              ...
              <p style={{marginTop:'0px'}}className='created'>Created on: {program.createdDate}</p>
            </div>
          </div>
